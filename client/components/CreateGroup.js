...
class CreateGroup extends React.Component {
 ...
 componentDidMount() {
		fetch('/api/user/mygroups/create', { credentials: 'include'})
		.then(res => res.json())
  ...
  handleSubmit(e) {
		e.preventDefault();
		let { subject, categories, descriptions, rules, courselinks, size, 
    ...
    fetch('/api/group/create', {
			...
			body: JSON.stringify({
				...
				subject, categories, descriptions, rules, courselinks, size, 
        sunday, monday, tuesday, wednesday, thursday, friday, saturday
			})
		})
		.then(resp => resp.json())
      ...
      auth.login(() => {
		...
		.catch(err => console.log('CreateCharacter fetch /api/user: ERROR: ', err));
  }
